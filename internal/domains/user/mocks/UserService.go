...
func (_m *UserService) Create(name string, age int, movieGenre string) (*user.User, error) {
...
func (_m *UserService) GetAll() ([]user.User, error) {
	ret := _m.Called()
...
func (_m *UserService) GetById(id int64) (*user.User, error) {
	ret := _m.Called(id)
...
func (_m *UserService) UpdateAge(id int64, age int) (*user.User, error) {
